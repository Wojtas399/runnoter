...
class _NoWorkoutInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          Str.of(context).day_preview_no_workout_title,
        ...
        BigButton(
          label: Str.of(context).day_preview_add_workout_button_label,
          onPressed: () {
...
class _NoWorkoutMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String message = Str.of(context).day_preview_no_workout_message_future_day;
    if (isPastDay) {
      message = Str.of(context).day_preview_no_workout_message_past_day;
    }
    return Text(
      message,
